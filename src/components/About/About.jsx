            ...
            <div className='about-content'>
                <div className='about-grid grid'>
                    ...
                    <div className='section-title'>
                        <h3 className='text-brown'>I'm <span className='text-dark'>Sitesh</span></h3>
                        <p className='text mx-auto'>I design and develop services for customers of all sizes, specializing in creating stylish, modern websites.</p>
                        <h2>Contact Me</h2>
                        <p>: +91-8457092615</p>
                        <div><h5>Mail ID </h5>
                        <p>: siteshdas01@gmail.con</p>
                        </div>
